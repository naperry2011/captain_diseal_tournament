...
/**
 * Error boundary for the tournament routes. Error boundaries must be client
 * components. Gives the streamer a branded recovery point instead of a raw
 * stack trace mid-broadcast.
 */
    ...
    <section className="flex min-h-[50vh] flex-col items-center justify-center gap-6 text-center">
      <div className="flex flex-col gap-2">
        ...
        <p className="max-w-md text-dojo-ash">
          The bracket took a hit. Try again, or head back to the dashboard.
        </p>
        {error.digest && (
